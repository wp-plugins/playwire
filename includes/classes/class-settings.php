...
class PlaywireSettings extends Playwire {
	...
	*/
	...
	?>
		<p><a class="help-click">OPEN HELP SECTION</a>
		 Step-by-step instructional videos to help you use the Playwire Wordpress Plugin</p>
		...
		<div id="help-section">
			...
			<script data-config='//config.playwire.com/1006036/videos/v2/3670323/zeus.json' data-css='//cdn.playwire.com/bolt/js/zeus/skins/default.css' data-height='100%' data-width='100%' src='//cdn.playwire.com/bolt/js/zeus/embed.js' type='text/javascript'></script>
			</div>
			...
			<div class='success-video'>
			<script data-config='//config.playwire.com/1006036/videos/v2/3670306/zeus.json' data-css='//cdn.playwire.com/bolt/js/zeus/skins/default.css' data-height='100%' data-width='100%' src='//cdn.playwire.com/bolt/js/zeus/embed.js' type='text/javascript'></script>
			</div>
			...
			<script data-config='//config.playwire.com/1006036/videos/v2/3670274/zeus.json' data-css='//cdn.playwire.com/bolt/js/zeus/skins/default.css' data-height='100%' data-width='100%' src='//cdn.playwire.com/bolt/js/zeus/embed.js' type='text/javascript'></script>
			</div>
