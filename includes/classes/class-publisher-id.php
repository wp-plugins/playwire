	...
	public function login_success_sync(){
		...
		'playwire-settings') { 
				...
				if( $token ){
			    	...
			    	$update_message = "<div class='green-warning animated pulse'><h2 class='error-styles'>Your Playwire.com account was successfully linked!</br></h2></div>";
			      	add_settings_error('general', 'settings_updated', $update_message, 'successs');

			    	// custom success message
			      	//$update_message = "<div class='green-warning animated pulse'><h2 class='error-styles'>Your Playwire.com account was successfully linked!</br></h2></div><div class='success-instructions'><h2>View and Upload Videos</h2><h4>*PLEASE NOTE - <em>You can upload videos from Playwire.com <strong>and</strong> from this Plugin.</em></h4><h4>If you have already have videos on Playwire.com, they should be here:<br><a href='$video_url'>Playwire Video &gt;Videos</a></h4><h4>If you have no videos on Playwire.com, watch the tutorial video to learn how to upload your videos to Playwire.com from the Playwire Video Wordpress Plugin.</h4></div><div class='success-video'><script data-config='//config.playwire.com/1000830/videos/v2/3652253/zeus.json' data-css='//cdn.playwire.com/bolt/js/zeus/skins/default.css' data-height='100%' data-width='100%' src='//cdn.playwire.com/bolt/js/zeus/embed.js' type='text/javascript'></script></div><hr class='success-hr'><div class='success-instructions'><h3>Create Video Galleries from Playlists on Playwire.com</h3><h4>*PLEASE NOTE* - <em>Playwire Playlists are <strong>NOT</strong> the same as Video Galleries you create with this Plugin</em></h4><h4>You can easily create custom Video Galleries to embed in your pages with this plugin. Watch the tutorial video to learn how create Video Galleries from your Playwire Playlists.</h4></div><div class='success-video'><script data-config='//config.playwire.com/1000830/videos/v2/3652253/zeus.json' data-css='//cdn.playwire.com/bolt/js/zeus/skins/default.css' data-height='100%' data-width='100%' src='//cdn.playwire.com/bolt/js/zeus/embed.js' type='text/javascript'></script></div><hr class='success-hr'><div class='success-instructions'><h3>Embedding Videos and Video Galleries in Your Page or Post</h3><h4>You can easily embed Videos and Video Galleries in your Wordpress Pages and Posts. Watch the tutorial video to learn how.</h4></div><div class='success-video'><script data-config='//config.playwire.com/1000830/videos/v2/3652253/zeus.json' data-css='//cdn.playwire.com/bolt/js/zeus/skins/default.css' data-height='100%' data-width='100%' src='//cdn.playwire.com/bolt/js/zeus/embed.js' type='text/javascript'></script></div>";
			      	//add_settings_error('general', 'settings_updated', $update_message, 'successs');
