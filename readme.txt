...
= 1.0.4 =
* Naming changes, Plugin is now called "Playwire Wordpress Video Player", added "Playwire Settings" to Playwire Admin menu, did API token and Sync checkbox from settings login, added loading screen after clicking "Save Settings"
